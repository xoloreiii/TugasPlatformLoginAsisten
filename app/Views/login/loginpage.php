...
<body>
  <!-- Interface Navbar n Input Pesan-->
  <!-- Navigasi -->
      ...
      <div class="container justify-content-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/login/loginpage">Login Page</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container mt-3">
      ...
      <form method="POST" action="/login/check">
        <div class="mb-3 mt-3">
            <?= csrf_field() ?>
            <p>
            <label for="username" type="text" name="username">User : </label>
            ...
            <br>
            <button name="submit" type="submit" value="login" class="form-control" style="background-color: #9029ace4 ; color: #fff;">Submit</button>
            </p>
        </div>
