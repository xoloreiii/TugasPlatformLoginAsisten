      ...
      <div class="container justify-content-center">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/asisten/search">Search</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container mt-3">
      ...
      <form method="POST" action="/asisten/search">
        <div class="mb-3 mt-3">
            <?= csrf_field() ?>
            <p>
            <label for="key" type="text" name="key">Search : </label>
            <input class="form-control" type="text" id="key"  name="key"><br>
            <button name = "submit" values = "search" type="submit" class="form-control" style="background-color: #9029ace4 ; color: #fff;">Submit</button>
            </p>
        </div>
      </form>
      <?php 
        if(!empty($hasil)) {
            ...
            // untuk nama, praktikum, ipk ini disesuaikan dari tabel asisten di database
